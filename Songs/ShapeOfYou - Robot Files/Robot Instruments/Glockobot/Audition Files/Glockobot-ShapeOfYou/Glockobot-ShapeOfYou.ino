...
const int MaxNumSongs = 4;  // Number of songs or parts to be loaded
const int NumSongs = 4;     // Number of songs or parts to be loaded

const int Tune1Length = 6;
const int Tune1ArrayLength = 36;
const int Tune1NoteMax = 3;
const int Tune1Tempo = 96;
const int Tune1BeatDenom = 4;

const int Tune2Tempo = 64;

  // Part 1 - OK
const unsigned int Tune1[2][Tune1ArrayLength] PROGMEM = {
  {0,0,0,3,3,3,6,6,6,8,8,8,11,11,11,14,14,14,16,16,16,19,19,19,22,22,22,24,24,24,27,27,27,30,30,30},
  {85,92,97,100,92,85,85,92,97,97,93,78,78,93,100,97,93,78,81,93,97,100,93,81,81,93,97,99,90,83,83,90,97,95}};
  
  // Part 2 - Too slow
const unsigned int Tune2[2][Tune1ArrayLength] PROGMEM = {
  {0,0,0,3,3,3,6,6,6,8,8,8,11,11,11,14,14,14,16,16,16,19,19,19,22,22,22,24,24,24,27,27,27,30,30,30},
  {85,92,97,100,92,85,85,92,97,97,93,78,78,93,100,97,93,78,81,93,97,100,93,81,81,93,97,99,90,83,83,90,97,95}};

  // Part 3 - Wrong notes
const unsigned int Tune3[2][Tune1ArrayLength] PROGMEM = {
  {0,0,0,3,3,3,6,6,6,8,8,8,11,11,11,14,14,14,16,16,16,19,19,19,22,22,22,24,24,24,27,27,27,30,30,30},
  {85,92,97,99,92,85,85,92,97,97,93,78,78,93,99,97,93,78,81,93,97,100,93,81,81,93,97,99,90,83,83,90,97,95}};

  // Part 4 - Wrong timing
const unsigned int Tune4[2][Tune1ArrayLength] PROGMEM = {
  {0,0,0,4,4,4,6,6,6,8,8,8,12,12,12,14,14,14,16,16,16,20,20,20,22,22,22,24,24,24,27,27,27,30,30,30},
  {85,92,97,100,92,85,85,92,97,97,93,78,78,93,100,97,93,78,81,93,97,100,93,81,81,93,97,99,90,83,83,90,97,95}};
...
void setup() 
{
    ...
    Tune_Info[1][0] =  Tune1Length;
    Tune_Info[1][1] =  Tune1NoteMax;
    Tune_Info[1][2] =  Tune2Tempo;
    Tune_Info[1][3] =  Tune1BeatDenom;

    Tune_Info[2][0] =  Tune1Length;
    Tune_Info[2][1] =  Tune1NoteMax;
    Tune_Info[2][2] =  Tune1Tempo;
    Tune_Info[2][3] =  Tune1BeatDenom;

    Tune_Info[3][0] =  Tune1Length;
    Tune_Info[3][1] =  Tune1NoteMax;
    Tune_Info[3][2] =  Tune1Tempo;
    Tune_Info[3][3] =  Tune1BeatDenom;
